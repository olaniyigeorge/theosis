...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Theosis | A Knowledge Graph of Scripture",
    description:
      "Every person, place, and story in Scripture, connected by relationships that cite chapter and verse.",
    siteName: "Theosis",
    images: [
      {
        url: "/assets/images/theosis-og-image.png",
        width: 1200,
        height: 630,
        alt: "Theosis — A Knowledge Graph of Scripture",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Every person, place, and story in Scripture, connected by relationships that cite chapter and verse.",
    images: ["/assets/images/theosis-og-image.png"],
